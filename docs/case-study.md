...
![Fitted hero — Daily Fit screen concept](/images/fitted-hero.webp)
...
![System architecture diagram — Flutter → Supabase → AI Services](/images/fitted-architecture.webp)
...
![Database entity-relationship diagram — eight core tables](/images/fitted-data-model.webp)
...
![AI orchestration pipeline — from clothing input to recommendations](/images/fitted-ai-pipeline.webp)
...
![Design system spec board — colors, typography, spacing](/images/fitted-design-system.webp)
